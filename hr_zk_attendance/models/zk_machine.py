            ...
            try:
                ...
                if conn:
                    ...
                    if clear_data:
                        ...
                        raise osv.except_osv(_('Error'), _('Unable to get the attendance log, please try again later.'))
                else:
                    raise osv.except_osv(_('Error'), _('Unable to connect, please check the parameters and network connections.'))
            except:
